...
1.**技能提取要准确**
  ...
  - 如果简历中提到版本号，也要提取(比如"Python3.8+”、"React18”)
  - 按照出现频率排序，最重要的技能放前面
...
- **项目经验**(4-5题，35%):结合JD要求和候选人简历，针对简历中的具体项目深挖细节C
...
3.**亮点提炼**:突出候选人的优势和成果
4.**内容清楚**:每个答案内容要清楚有深度，字数在200 - 300字之间
...
4.sumary要具体，根据简历与JD的对比进行分析简历中不足的地方，给出具体的建议，避免泛泛而谈
